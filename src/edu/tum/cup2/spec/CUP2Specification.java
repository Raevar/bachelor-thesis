		...
		/**/{
			...
			TreeSet<Terminal> insertables = new TreeSet<Terminal>( new Comparator<Terminal>() {
				public int compare(Terminal o1, Terminal o2) {
					...
					try { ins1 = (Insertable) Reflection.getFieldValueOrNull(o1, "insert"); } catch (Exception e) {}
					try { ins2 = (Insertable) Reflection.getFieldValueOrNull(o2, "insert"); } catch (Exception e) {}
